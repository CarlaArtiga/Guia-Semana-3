...
public class Triangulo {
    ...
    public static void main(String[] args) {
        ...
        if(CantEqui < CantIso && CantEqui < CantEsca){
            System.out.println("Menor Cantidad de triangulos: equilateros");
        }
        else if (CantIso < CantEqui && CantIso < CantEsca){
            System.out.println("Menor cantidad de triangulos: isoceles");
        }
        else if (CantEsca < CantEqui && CantEsca < CantIso){
            System.out.println("Menor cantidad de traingulos: escalenos");
        }
